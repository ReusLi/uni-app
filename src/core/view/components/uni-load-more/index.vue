<template><VUniView
  ...
  <VUniView
    ...
    <VUniView :style="{borderTopColor:color,borderTopWidth:iconSize/12}"/>
    <VUniView :style="{borderTopColor:color,borderTopWidth:iconSize/12}"/>
    <VUniView :style="{borderTopColor:color,borderTopWidth:iconSize/12}"/>
  </VUniView>
  <!-- #endif -->
  ...
  <VUniText
    :style="{color: color}"
    class="uni-load-more__text">{{ status === 'more' ? contentText.contentdown : status === 'loading' ? contentText.contentrefresh : contentText.contentnomore }}</VUniText>
</VUniView>
</template>
