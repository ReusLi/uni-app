<template>
  <view
    ...
    <view
      ...
      <view
        v-if="title"
        class="uni-card__thumbnailimage-title"><text class="uni-card__thumbnailimage-title-text">{{ title }}</text></view>
    </view>
    <view
      v-if="mode === 'title'"
    ...
    <view
      ...
      <text
        v-if="extra"
        class="uni-card__header-extra-text">{{ extra }}</text>
    </view>
    <!-- 内容 -->
    <view class="uni-card__content uni-card__content--pd">
      <view
        v-if="mode === 'style' && extra"
        class=""><text class="uni-card__content-extra">{{ extra }}</text></view>
      <slot />
    </view>
    <!-- 底部 -->
    <view
