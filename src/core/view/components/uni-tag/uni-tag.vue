<template><VUniView :class="[
      ...
      'uni-tag--' + size
		...
		<VUniText :class="[type === 'default' ? 'uni-tag--default':'uni-tag-text',inverted === true || inverted === 'true' ? 'uni-tag-text--'+type : '',size === 'small' ? 'uni-tag-text--small':'' ]">{{ text }}</VUniText>
	</VUniView>
</template>
