    ...
    <div
      ...
      >
        <div class="uni-tabbar__bd">
          ...
          >
            <img
              :src="item.isSelected && item.selectedIconPath?item.selectedIconPath:item.iconPath"
            >
            <div
              v-if="item.redDot"
          ...
          <div
            v-if="item.text"
            :style="{color:item.isSelected?selectedColor:color,fontSize:item.iconPath?'10px':'14px'}"
